...
class NessusCLI < NessusCLIBase
  ...
  subcommand 'scan', NessusCLI::Scan

  desc "policy", "Policy related commands"
  subcommand 'policy', NessusCLI::Policy
end